...
NS_SWIFT_NAME(CATDefaultNetworkConnectionBuilder)
@protocol CATDefaultNetworkConnectionBuilder <NSObject>

/*!
 @brief Builder method to set the api key.
...
/*!
 ...
 @param method Should be CATHttpMethodGet or CATHttpMethodPost.
 */
- (void) setHttpMethod:(CATHttpMethod)method;
...
@interface CATDefaultNetworkConnection : NSObject <CATNetworkConnection, CATDefaultNetworkConnectionBuilder>

/*!
 @brief Builds the DefaultNetworkConnection using a build block of functions.
 */
+ (instancetype) build:(void(^)(id<CATDefaultNetworkConnectionBuilder>builder))buildBlock;
