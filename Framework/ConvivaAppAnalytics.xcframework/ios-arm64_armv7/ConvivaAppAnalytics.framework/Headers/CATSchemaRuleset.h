...
NS_SWIFT_NAME(CATSchemaRuleset)
@interface CATSchemaRuleset : NSObject <NSCopying>
 ...
 */
+ (CATSchemaRuleset *)rulesetWithAllowedList:(NSArray<NSString *> *)allowed;
/*!
 Generate a set of rules based on allowed and denied event schemas.
 @param denied Rules of denied schemas.
 */
+ (CATSchemaRuleset *)rulesetWithDeniedList:(NSArray<NSString *> *)denied;
/*!
 Generate a set of rules based on allowed and denied event schemas.
 @param allowed Rules of allowed schemas.
 @param denied Rules of denied schemas.
 */
+ (CATSchemaRuleset *)rulesetWithAllowedList:(NSArray<NSString *> *)allowed andDeniedList:(NSArray<NSString *> *)denied;
