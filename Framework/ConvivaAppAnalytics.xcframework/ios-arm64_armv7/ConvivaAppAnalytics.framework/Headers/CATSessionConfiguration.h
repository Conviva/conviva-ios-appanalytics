...
NS_SWIFT_NAME(CATSessionConfigurationProtocol)
@protocol CATSessionConfigurationProtocol
 ...
 */
NS_SWIFT_NAME(CATSessionConfiguration)
@interface CATSessionConfiguration : CATConfiguration <CATSessionConfigurationProtocol>
