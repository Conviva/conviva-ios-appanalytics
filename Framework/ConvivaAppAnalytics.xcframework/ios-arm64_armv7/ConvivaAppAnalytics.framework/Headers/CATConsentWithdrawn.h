...
NS_SWIFT_NAME(CATConsentWithdrawn)
@interface CATConsentWithdrawn : CATSelfDescribingAbstract
...
/// Other documents.
@property (nonatomic, nullable) NSArray<CATSelfDescribingJson *> *documents;

/// Retuns the full list of attached documents.
- (NSArray<CATSelfDescribingJson *> *)getDocuments;
...
/// Other documents.
SP_BUILDER_DECLARE_NULLABLE(NSArray<CATSelfDescribingJson *> *, documents)
