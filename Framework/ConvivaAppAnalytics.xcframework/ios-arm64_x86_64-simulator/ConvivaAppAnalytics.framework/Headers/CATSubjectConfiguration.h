...
@interface CISSize : NSObject <NSCoding>
...
NS_SWIFT_NAME(CATSubjectConfigurationProtocol)
@protocol CATSubjectConfigurationProtocol
 ...
 */
@property (nullable) CISSize *screenResolution;
/**
 * The screen viewport.
 * Note: It's not generated by the tracker, it needs to be filled by the developer when instrumenting the tracker.
 */
@property (nullable) CISSize *screenViewPort;
/**
 * The color depth.
 * Note: It's not generated by the tracker, it needs to be filled by the developer when instrumenting the tracker.
 */
 ...
 */
NS_SWIFT_NAME(CATSubjectConfiguration)
@interface CATSubjectConfiguration : CATConfiguration <CATSubjectConfigurationProtocol>
 ...
 * The screen resolution.
 */
SP_BUILDER_DECLARE_NULLABLE(CISSize *, screenResolution)
/**
 * The screen viewport.
 * Note: It's not generated by the tracker, it needs to be filled by the developer when instrumenting the tracker.
 */
SP_BUILDER_DECLARE_NULLABLE(CISSize *, screenViewPort)
/**
 * The color depth.
 * Note: It's not generated by the tracker, it needs to be filled by the developer when instrumenting the tracker.
 */
