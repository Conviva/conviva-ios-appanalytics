...
@class CATScreenState;

NS_ASSUME_NONNULL_BEGIN

/// A screenview event.
NS_SWIFT_NAME(CATScreenView)
@interface CATScreenView : CATSelfDescribingAbstract
...
/// Loaded to memory time stamp.
@property (nonatomic, nullable) NSNumber *loadToMemoryTimestamp;
// Shown on view appear time stamp.
@property (nonatomic, nullable) NSNumber *viewDidAppearTimestamp;
...
/// Loaded to memory time stamp.
SP_BUILDER_DECLARE_NULLABLE(NSString *, loadToMemoryTimestamp)
// Shown on view appear time stamp.
SP_BUILDER_DECLARE_NULLABLE(NSString *, viewDidAppearTimestamp)
