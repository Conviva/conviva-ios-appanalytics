 ...
 */
NS_SWIFT_NAME(CATNetworkConfiguration)
@interface CATNetworkConfiguration : CATConfiguration
 ...
 */
@property (nonatomic, readonly) CATProtocol protocol;

/**
 * See `NetworkConfiguration(NetworkConnection)`
 */
@property (nonatomic, nullable) id<CATNetworkConnection> networkConnection;
