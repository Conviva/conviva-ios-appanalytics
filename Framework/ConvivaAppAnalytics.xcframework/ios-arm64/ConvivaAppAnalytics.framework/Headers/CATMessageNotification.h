...
NS_SWIFT_NAME(CATMessageNotificationTrigger)
typedef NS_ENUM(NSUInteger, CATMessageNotificationTrigger) {
    CATMessageNotificationTriggerPush = 0,
    CATMessageNotificationTriggerLocation,
    CATMessageNotificationTriggerCalendar,
    CATMessageNotificationTriggerTimeInterval,
    CATMessageNotificationTriggerOther
};


/// An event that represents the reception of a push notification (or a locally generated one).
NS_SWIFT_NAME(CATMessageNotification)
@interface CATMessageNotification : CATSelfDescribingAbstract
...
@property (nonatomic, nullable) NSArray<CATMessageNotificationAttachment *> *attachments;
...
@property (nonatomic, readonly) CATMessageNotificationTrigger trigger;
...
- (instancetype)initWithTitle:(NSString *)title
                         body:(NSString *)body
                      trigger:(CATMessageNotificationTrigger)trigger;

/// The action associated with the notification.
SP_BUILDER_DECLARE_NULLABLE(NSString *, action)
/// Attachments added to the notification (they can be part of the data object).
SP_BUILDER_DECLARE_NULLABLE(NSArray<CATMessageNotificationAttachment *> *, attachments)
/// Variable string values to be used in place of the format specifiers in bodyLocArgs to use to localize the body text to the user's current localization.
 ...
 */
+ (nullable CATMessageNotification *)messageNotificationWithUserInfo:(NSDictionary *)userInfo defaultTitle:(nullable NSString *)defaultTitle defaultBody:(nullable NSString *)defaultBody;
