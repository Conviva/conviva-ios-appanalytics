...
#ifndef CONVIVAAPPANALYTICS_SWIFT_H
#define CONVIVAAPPANALYTICS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ConvivaAppAnalytics",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC19ConvivaAppAnalytics16CATCrashObserver") SWIFT_AVAILABILITY(ios,introduced=14.0)
@interface CATCrashObserver : NSObject
- (nonnull instancetype)initWithTracker:(id <CATTrackerController> _Nonnull)tracker OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC19ConvivaAppAnalytics22CATFoundationTransport")
@interface CATFoundationTransport : NSObject <NSStreamDelegate>
...
SWIFT_CLASS("_TtC19ConvivaAppAnalytics15CATHangObserver") SWIFT_AVAILABILITY(ios,introduced=14.0)
@interface CATHangObserver : NSObject
- (nonnull instancetype)initWithTracker:(id <CATTrackerController> _Nonnull)tracker OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC19ConvivaAppAnalytics15CATNativeEngine") SWIFT_AVAILABILITY(tvos,introduced=13.0) SWIFT_AVAILABILITY(watchos,introduced=6.0) SWIFT_AVAILABILITY(ios,introduced=13.0) SWIFT_AVAILABILITY(macos,introduced=10.15)
@interface CATNativeEngine : NSObject <NSURLSessionDataDelegate, NSURLSessionWebSocketDelegate>
...
///
/// \endcode
SWIFT_CLASS("_TtC19ConvivaAppAnalytics16CATOnAckCallback")
@interface CATOnAckCallback : NSObject
...
/// To check for timeout, use <code>CATSocketAckStatus</code>’s <code>noAck</code> case.
///
...
@class CATSocketRawAckView;

/// A class that represents a waiting ack call.
/// <em>NOTE</em>: You should not store this beyond the life of the event handler.
SWIFT_CLASS("_TtC19ConvivaAppAnalytics19CATSocketAckEmitter")
@interface CATSocketAckEmitter : NSObject
...
@property (nonatomic, readonly, strong) CATSocketRawAckView * _Nonnull rawEmitView;
...
SWIFT_CLASS("_TtC19ConvivaAppAnalytics17CATSocketAnyEvent")
@interface CATSocketAnyEvent : NSObject
/// The event name.
...
/// See <code>CATSocketEnginePollable</code> and <code>CATSocketEngineWebsocket</code> for transport specific methods.
SWIFT_CLASS("_TtC19ConvivaAppAnalytics15CATSocketEngine")
@interface CATSocketEngine : NSObject <NSURLSessionDelegate>
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_PROTOCOL("_TtP19ConvivaAppAnalytics21CATSocketEngineClient_")
@protocol CATSocketEngineClient
...
typedef SWIFT_ENUM(NSInteger, CATSocketEnginePacketType, open) {
/// Open message.
  CATSocketEnginePacketTypeOpen = 0,
/// Close message.
  CATSocketEnginePacketTypeClose = 1,
/// Ping message.
  CATSocketEnginePacketTypePing = 2,
/// Pong message.
  CATSocketEnginePacketTypePong = 3,
/// Regular message.
  CATSocketEnginePacketTypeMessage = 4,
/// Upgrade message.
  CATSocketEnginePacketTypeUpgrade = 5,
/// NOOP.
  CATSocketEnginePacketTypeNoop = 6,
};


/// Represents a socket.io-client.
/// Clients are created through a <code>CATSocketManager</code>, which owns the <code>CATSocketEngineSpec</code> that controls the connection to the server.
/// For example:
/// \code
...
SWIFT_CLASS("_TtC19ConvivaAppAnalytics17CATSocketIOClient")
@interface CATSocketIOClient : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

/// Represents state of a manager or client.
typedef SWIFT_ENUM(NSInteger, CATSocketIOStatus, open) {
/// The client/manager has never been connected. Or the client has been reset.
  CATSocketIOStatusNotConnected = 0,
/// The client/manager was once connected, but not anymore.
  CATSocketIOStatusDisconnected = 1,
/// The client/manager is in the process of connecting.
  CATSocketIOStatusConnecting = 2,
/// The client/manager is currently connected.
  CATSocketIOStatusConnected = 3,
};

@class NSURL;

/// A manager for a socket.io connection.
/// A <code>CATSocketManager</code> is responsible for multiplexing multiple namespaces through a single <code>CATSocketEngineSpec</code>.
/// Example:
/// \code
/// let manager = CATSocketManager(socketURL: URL(string:"http://localhost:8080/")!)
...
/// To disconnect a socket and remove it from the manager, either call <code>CATSocketIOClient.disconnect()</code> on the socket,
...
SWIFT_CLASS("_TtC19ConvivaAppAnalytics16CATSocketManager")
@interface CATSocketManager : NSObject
/// Not so type safe way to create a CATSocketIOClient, meant for Objective-C compatiblity.
/// If using Swift it’s recommended to use <code>init(socketURL: NSURL, options: Set<CATSocketIOClientOption>)</code>
...
///
/// \endcode
SWIFT_CLASS("_TtC19ConvivaAppAnalytics19CATSocketRawAckView")
@interface CATSocketRawAckView : NSObject
/// Call to ack receiving this event.
/// \param items An array of items to send when acking. Use <code>[]</code> to send nothing.
///
- (void)with:(NSArray * _Nonnull)items;
...
///
/// \endcode
SWIFT_CLASS("_TtC19ConvivaAppAnalytics16CATSocketRawView")
@interface CATSocketRawView : NSObject
...
///
/// returns:
/// An <code>CATOnAckCallback</code>. You must call the <code>timingOut(after:)</code> method before the event will be sent.
- (CATOnAckCallback * _Nonnull)emitWithAck:(NSString * _Nonnull)event with:(NSArray * _Nonnull)items SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

@protocol CATWebSocketManagerBridgeDelegate;

SWIFT_CLASS("_TtC19ConvivaAppAnalytics25CATWebSocketManagerBridge")
@interface CATWebSocketManagerBridge : NSObject
@property (nonatomic, weak) id <CATWebSocketManagerBridgeDelegate> _Nullable delegate;
- (nonnull instancetype)initWithSocketURL:(NSURL * _Nonnull)socketURL jwt:(NSString * _Nonnull)jwt OBJC_DESIGNATED_INITIALIZER;
- (void)connect;
- (void)connectWithPayload:(NSDictionary<NSString *, id> * _Nullable)payload;
- (void)disconnect;
- (void)emitBinaryWithEvent:(NSString * _Nonnull)event binaryData:(NSData * _Nonnull)binaryData;
- (void)emitEventWithAck:(NSString * _Nonnull)event completion:(void (^ _Nonnull)(void))completion;
...
SWIFT_PROTOCOL("_TtP19ConvivaAppAnalytics33CATWebSocketManagerBridgeDelegate_")
@protocol CATWebSocketManagerBridgeDelegate
- (void)socketDidConnect;
- (void)socketDidDisconnect;
- (void)socketDidReceiveWithEvent:(NSString * _Nonnull)event data:(NSArray * _Nonnull)data;
- (void)socketDidReceiveError:(NSError * _Nullable)error;
@end
