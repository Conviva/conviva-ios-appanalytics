...
/// An ecommerce event.
NS_SWIFT_NAME(CATEcommerce)
@interface CATEcommerce : CATPrimitiveAbstract
...
/// Items purchased.
@property (nonatomic, readonly) NSArray<CATEcommerceItem *> *items;
 ...
 */
- (instancetype)initWithOrderId:(NSString *)orderId totalValue:(NSNumber *)totalValue items:(NSArray<CATEcommerceItem *> *)items NS_SWIFT_NAME(init(orderId:totalValue:items:));

/// List of the items purchased.
- (NSArray<CATEcommerceItem *> *)getItems;
